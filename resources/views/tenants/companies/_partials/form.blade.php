...
<div class="form-row">
    <div class="form-group col-sm-12 col-md-6">
        ...
        <input type="text" required class="form-control" id="bd_database" name="bd_database" placeholder="Nome da Base de Dados">
    </div>
    <div class="form-group col-sm-12 col-md-6">
        <label for="bd_hostname" class="required">BD Host</label>
        <input type="text" required class="form-control" id="bd_hostname" name="bd_hostname" placeholder="Hostname da Base De Dados">
    </div>
</div>
<div class="form-row">
    <div class="form-group col-sm-12 col-md-6">
        <label for="bd_username" class="required">BD Usuário</label>
        <input type="text" required class="form-control" id="bd_username" name="bd_username" placeholder="Usuário da Base de Dados">
    </div>
    <div class="form-group col-sm-12 col-md-6">
        <label for="bd_password" class="required">BD Senha</label>
        <input type="password" required class="form-control" id="bd_password" name="bd_password" placeholder="Senha da Base De Dados">
    </div>
</div>
