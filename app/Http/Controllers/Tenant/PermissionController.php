...
{
    private $service;
    private $title = "Permissão";
    private $routePath = 'tenants.permissions';
    ...
    public function edit($id)
    {
        ...
        return view("{$this->routePath}.update", compact('permission', 'items'));
    }
    ...
    private function validateRequest($request)
    {
        return Validator::make(
            $request->all(),
            (new PermissionRequest())->rules($request),
            (new PermissionRequest())->messages()
        );
    }
